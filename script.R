...
corrplot(corr.matrix, method = "number", type = "upper", diag = FALSE, number.cex=0.75, tl.cex = 2)
...
#treba  da bude sto horizontalnije, to su nase pretpostavljenje vrednsosti prema stvarnim, i treba sto grupisanije oko horizontale
#normal quantile-quantile (norma probability), predstavlja raspodelu podataka u odnosu na normalnu, treba po lin
#da li su reziduali jednako SPREADOVANI - rasporedjeni po prediktorima
#poaze nam da nadjemo outliers, ukoliko je neki plot van 
